    ...
    <div>
      ...
      <div id="section2" style={{ backgroundImage: `url(${tosee2})` }}>
        <Col md="12">
          ...
          <Row>
            <Col md="6" className="container2column" style={{}}>
              <AnimationWrapper>
                <Col
                  sm="12"
                  className="photoheight"
            ...
            <Col md="6"  className="container2column">
              <Col sm="12" classID="container2insider">
                <Col sm="8" className="container2insideitem">
                  <h6
                    data-aos="fade-up"
                ...
                >
                  ...
                  which includes giving support to my customers, maintain
                  quality releases of my product-CAMWorks, conducting training
                  on CAMWorks. I always find ways to improve my work and make it
                  more efficient. I take more pride in handling support cases on
