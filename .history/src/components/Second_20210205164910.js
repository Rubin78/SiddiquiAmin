          ...
          <Row>
            ...
            <Col md="4">
              <div className="experincedetailscenter">
                <p>
                  Providing online support to our customers. Either through mail
                  or through online meeting.
                </p>
                <p>Provide telephonic support if required.</p>

                <p>
                  Provide training to new users. Solve License related issues on
                  priority.
                </p>
            ...
            <Col md="4">
              <div className="techicalskills">
                <p>Take responsibility of the upcoming new enhancements
                (functionality) in new versions. </p>
                <p>. Discussion on specification
                document written by product manager.</p> 
                <p>. Creating System Test
                Plan (STP). </p>
                <p>. Executing System Test Plan. </p>
                <p>. Finding bugs/enhancements and adding in issuebase.</p> 
                <p>. Suggesting any modifications in UI or in functionality to product manager and
                approving it for the same.</p>
                 <p>. Guiding the Technical writer to
                include the new enhancements in Help files and Tutorials. </p>
                <p>. Giving sign-off of the enhancements. </p>
                <p>. Explaining the new
                enhancements to others in the team. </p>
                <p>Conducting webinar on topics
                like Whats New in CAMWorks version.</p>
              </div>
            </Col>
          </Row>
        </div>
