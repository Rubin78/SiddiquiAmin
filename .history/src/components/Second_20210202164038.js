...
useEffect(()=>{
  ...
  return (
    <div>
      ...
      <div id="section2" style={{ backgroundImage: `url(${tosee2})` }}>
        <Col md="12">
          <div className="aboutmeheadertextheight">
            <h1 data-aos="fade-left" className="Aboutme">
              ABOUT ME
        ...
        <Row>
          <Col md="6" sm="6" xs="12" className="container2column" style={{}}>
            <AnimationWrapper>
          ...
          <Col md="6" sm="6" xs="12" className="container2column">
            <Col sm="12" classID="container2insider">
              ...
              <Col
                ...
                className="mydetailsstyle"
              >
                I am working in HCL Technologies as Module QA Lead Engineer for
                12 years. I have completed my B.E in Production Engineering in
                the year 2001. I am passionate about my work which includes
                giving support to my customers, maintain quality releases of my
                product-CAMWorks, conducting training on CAMWorks. I always find
                ways to improve my work and make it more efficient. I take more
                pride in handling support cases on licensing. I make my juniors
                to work with full energetic and give best of their ability.
                Technical Skills:- SOLIDWORKS Modules- Modelling-8/10
                Manufacturing-9/10
              </Col>
