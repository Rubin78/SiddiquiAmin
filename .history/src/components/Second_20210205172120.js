          ...
          <Row>
            ...
            <Col md="4">
              ...
              <div className="experincedetailscenter">
                <p className="experiencesetailinside">&#8226; Providing online support to our customers.
                </p>
                <p>&#8226; Either through mail or through online meeting.</p>

                <p className="experiencesetailinside">&#8226; Provide telephonic support if required.
                </p>

                <p experiencesetailinside>&#8226; Provide training to new users. Solve License related
                  issues on priority.
                </p>

                <p experiencesetailinside>&#8226; Identify bugs/enhancements in our product and enter it
                  in issuebase.
                </p>

                <p experiencesetailinside>&#8226; Analyzing the bug fixes done by the development team
                  and closing/reopening the bugs.
                </p>
                <p experiencesetailinside>
                  &#8226; Running regression test system everyday and analyzing
                  the diffs for any regressions.
                </p>
                <p experiencesetailinside>
                  &#8226; Modifying the regression test system to suite our
                  purpose.
                </p>
              </div>
              </Col>
            ...
            <Col md="5">
                            <Col sm="11" style={{backgroundColor:'red'}}>
              ...
              <div className="">
                ...
                <p>. Discussion on specification document written by product
                  manager.
                </p>
                <p>. Creating System Test Plan (STP). </p>
                <p>. Executing System Test Plan. </p>
                <p>. Finding bugs/enhancements and adding in issuebase.</p>
                <p>. Suggesting any modifications in UI or in functionality to
                  product manager and approving it for the same.
                </p>
                <p>. Guiding the Technical writer to include the new enhancements
                  in Help files and Tutorials.{" "}
                </p>
                <p>. Giving sign-off of the enhancements. </p>
                <p>. Explaining the new enhancements to others in the team. </p>
                <p> Conducting webinar on topics like Whats New in CAMWorks
                  version.
                </p>
              </div>
              </Col>
