            ...
            <Row>
              ...
              >
                <AnimationWrapper>
                  ...
                  >
                    <img src={port} className="Photosize" />
                  </Col>
                </AnimationWrapper>
              </Col>
...
<div style={{height:"85%",position:'relative', backgroundColor:'red',display:'flex',flexDirection:'column',justifyContent:'center' ,alignContent:'flex-start'}}>
        <Row>
          <Col md="4">
            <div className="techicalskills">
              <h1 data-aos="fade-up-left" className="Aboutme">
