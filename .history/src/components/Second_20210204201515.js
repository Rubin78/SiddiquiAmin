  ...
  return (
    <div>
      ...
      <div className="section" id="section4">
        ...
        <div className="techskillsdescription">
          <div className="col-md-8 col-sm-12  neonn" data-aos="fade-up-right">
            Currently working in HCL Technologies As a Module QA Lead since
            2008. I work as a QA for our inhouse develop CAM application name as
            CAMWorks. CAMWorks is a CAM solution with features like Automatic
            Feature Recognition (AFR), Knowledge-based machining. It covers
            modules like Mill, Turn, MillTurn and WireEDM.
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <Carousel.Item className="Caritem">
              <img className="d-block w-50" src={CAM} alt="Third slide" />
