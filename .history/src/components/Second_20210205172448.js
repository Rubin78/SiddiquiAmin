            ...
            <Col md="4">
              <Col sm="11">
                <div className="experincedetailscenter">
                  ...
                  <p className="experiencesetailinside">
                   Identify bugs/enhancements in our product and enter
                    it in issuebase.
                  </p>
                  ...
                  <p className="experiencesetailinside">
                   Running regression test system everyday and
                    analyzing the diffs for any regressions.
                  </p>
                  <p className="experiencesetailinside">
            ...
            <Col md="5">
              <Col sm="11" style={{ backgroundColor: "red" }}>
                <div className="">
                  ...
                  <p>
                    . Guiding the Technical writer to include the new
                    enhancements in Help files and Tutorials.{" "}
                  </p>
