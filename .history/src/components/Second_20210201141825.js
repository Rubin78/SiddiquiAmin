        ...
        >
          <div className="top-text">
            <div data-aos="fade-down-right" className="DesignInnovation">
              ...
              <br />
              <Typed
                strings={["SOLIDWORKS", "CAMWorks" , "Unigraphics", "CATIA" ,"MasterCAM", "I-deas "
              ...
              <Col md="6" sm="6" className="container2column">
                <Col sm="12" classID="container2insider">
                  ...
                  <Col md="6" sm="12" className="mydetailsstyle">
                    A passionate programmer , born and brought up in India. I am
                    a Web Developer with React.js, React.Native,
                    Flex,Boostrap4,Html5,Css3. I am Currently Working in Snoop
                    Technologies Pvt. Ltd. I successfully completed my
                    Engineering with specialization in 'Information Technology'
                    Working with the clients, my goal is always driven towards
                    providing amazing experience with the best level of quality
                    and service to them. Along with that, I also help people as
                    a COACH on their journey of becoming a professional
                    programmer. I love learning about new technologies, what
