      ...
      <div className="container3" id="container3">
        ...
        <Row>
          <Col md="12" className="Container2frontend">
            ...
            <h4 data-aos="fade-up-right" className="frontendfont">
              SOLIDWORKS (Rate: 8/10) 3D Modelling:- Refer images -SW-3D
              Modelling-1.png and SW-3D Modelling-2.png
            </h4>
            <h4>
              {" "}
              Currently working in HCL Technologies As a Module QA Lead since
              2008. I work as a QA for our inhouse develop CAM application name
              as CAMWorks. CAMWorks is a CAM solution with features like
              Automatic Feature Recognition (AFR), Knowledge-based machining. It
              covers modules like Mill, Turn, MillTurn and WireEDM.{" "}
            </h4>
