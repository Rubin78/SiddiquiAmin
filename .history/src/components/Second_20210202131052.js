                ...
                <Col sm="12" classID="container2insider">
                  ...
                  >
                    <div>
                      {" "}
                      I am working in{" "}
                      <p style={{ color: "blue" }}>HCL Technologies</p> as
                      Module QA Lead Engineer for 12 years
                    </div>
                    . I have completed my B.E in Production Engineering in the
                    year 2001. I am passionate about my work which includes
                    giving support to my customers, maintain quality releases of
                    my product-CAMWorks, conducting training on CAMWorks. I
                    always find ways to improve my work and make it more
                    efficient. I take more pride in handling support cases on
                    licensing. I make my juniors to work with full energetic and
                    give best of their ability. Technical Skills:- SOLIDWORKS
                    Modules- Modelling-8/10 Manufacturing-9/10
                  </Col>
