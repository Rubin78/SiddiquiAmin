...
useEffect(()=>{
  ...
  return (
    <div>
      ...
      <div className="section3" id="section4">
        <Row>
          <Col md="12">
            <div className="techicalskills">
              <h1 data-aos="fade-up-left" className="Aboutme">
      ...
      <div style={{ backgroundColor: "black", height: "85%",backgroundColor:'red' }}>
        <Carousel style={{ height: "60%",display:'flex' ,justifyContent:'center',alignContent:'center' }}>
          ...
          <Carousel.Item className="Caritem">
            <img className="d-block w-50" src={Modelling1} alt="Third slide" />
