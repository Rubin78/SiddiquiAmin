              ...
              <Col md="6" sm="6" xs="12" className="container2column">
                <Col sm="12" classID="container2insider">
                  <Col sm="8" className="container2insideitem">
                    <h6 className="seondfontfamily">
                       Hi, I am Amin Siddique.
                    </h6>
                  </Col>
                  <Col data-aos="fade-down"
     data-aos-easing="linear"
     data-aos-duration="1500" md="6" sm="12" className="mydetailsstyle">
                    I am working in HCL Technologies as
                    Module QA Lead Engineer for 12 years. I have completed my
                    B.E in Production Engineering in the year 2001. I am
                    passionate about my work which includes giving support to my
                    customers, maintain quality releases of my product-CAMWorks,
                    conducting training on CAMWorks. I always find ways to
                    improve my work and make it more efficient. I take more
                    pride in handling support cases on licensing. I make my
                    juniors to work with full energetic and give best of their
                    ability. Technical Skills:- SOLIDWORKS Modules-
                    Modelling-8/10 Manufacturing-9/10
                  </Col>
      ...
      <div className="container3" id="container3">
        ...
        <Row>
          <Col md="12" className="Container2frontend">
            <h1 data-aos="fade-up-right" className="frontendfont">
              FRONT END
            </h1>
